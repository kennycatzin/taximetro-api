...
var getViajes = function (req, res) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            mysql_1.default.ejecutarQuery(query, function (err, viajes) {
                if (err) {
                    res.status(400).json({
                        ok: false,
                        error: err
...
var storeViajes = function (req, res) {
    if (res === void 0) { res = response; }
    return __awaiter(void 0, void 0, void 0, function () {
        var _a, km, hora_inicio, hora_termino, precio, id_chofer, fecha, query;
        return __generator(this, function (_b) {
            _a = req.body, km = _a.km, hora_inicio = _a.hora_inicio, hora_termino = _a.hora_termino, precio = _a.precio, id_chofer = _a.id_chofer;
